...
<head>
    ...
    <title>Détails de la sortie - Cité des Sciences</title>
    <style>
        /* Style global */
        body {
...
<body>
    <div class="container">
        <h1>Sortie : Cité des Sciences</h1>
        <p>Rejoignez-nous pour une journée fascinante à la Cité des Sciences. Plongez dans le monde des sciences, des technologies et des découvertes éducatives, et partagez des moments enrichissants avec vos enfants.</p>

        <div class="details">
            <h2>Détails de la journée</h2>
            <p><strong>Date :</strong> 22 janvier 2025</p>
            ...
            <ul class="list">
                ...
                <li>09h30 - Arrivée à la Cité des Sciences</li>
                <li>10h00 - Visite guidée de l'exposition temporaire "Le cosmos expliqué"</li>
                <li>12h00 - Déjeuner sur place</li>
                <li>13h00 - Ateliers interactifs pour les enfants</li>
                <li>15h30 - Exploration libre des espaces permanents</li>
                <li>17h00 - Retour en bus vers la crèche</li>
            </ul>
            <p><strong>À prévoir :</strong></p>
            <ul class="list">
                <li>Sac à dos avec une bouteille d'eau</li>
                <li>Cahier et crayon (pour prendre des notes)</li>
        ...
        <div class="form">
            <h2>Inscription des accompagnateurs</h2>
            <form id="parent-form">
