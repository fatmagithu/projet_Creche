...
<body>
  ...
  <div class="content">
    <div class="chat-tabs-top">
      <button class="active">Chat Parents</button>
      <button onclick="window.location.href='PmessageParentAdmin.php'">Chat Équipe</button>
      <button onclick="window.location.href='chatAUX.php'">Contrôle Conversations</button>
    </div>

    <div class="app-container">
      <div class="parent-list">
        <div class="parent-item active">Mme Legrand <div class="notification">2</div></div>
        <div class="parent-item">M. Hamzaoui</div>
        <div class="parent-item">Mme Sarah D.</div>
        <div class="parent-item">Famille Bensalah</div>
      </div>

      <div class="main-chat">
        <div class="chat-title">Discussion avec Mme Legrand</div>

        <div class="messages" id="messagesContainer">
          <div class="message-bubble received">
            <div class="sender-name">Mme Legrand</div>
            Bonjour, sortie prévue cette semaine ?
            <div class="timestamp">08:40</div>
          </div>
          <div class="message-bubble sent">
            <div class="sender-name">Admin</div>
            Oui, vendredi matin au parc !
            <div class="timestamp">08:43</div>
          </div>
          <div class="message-bubble received">
            <div class="sender-name">Mme Legrand</div>
            Super, merci beaucoup !
            <div class="timestamp">08:44</div>
          </div>
        </div>
