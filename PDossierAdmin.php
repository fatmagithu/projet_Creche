...
<body>
  <div class="sidebar">
    ...
    <a href="PDossierAdmin.php"><img src="dossier.png" alt="dossier" class="icon active"></a>
    <a href="messages.php"><img src="message.png" alt="message" class="icon"></a>
    <a href="parametre.php"><img src="parametre.png" alt="parametre" class="icon"></a>
  </div>
