...
<button class="back-button" onclick="history.back()">
  ...
  <div class="chat-tabs-top">
    <button onclick="window.location.href='ParentMessageApp.php'">Chat avec la crèche</button>

  </div>

  <div class="app-container">
    <div class="parent-list">
      <div class="parent-item active">Sonia<div class="notification">2</div></div>

      <div class="parent-item">Manel <div class="notification">1</div></div>
      <div class="parent-item">Directrice Sofiya</div>
      <div class="parent-item">Fatou</div>
      <div class="parent-item">Fréderique</div>
     
    </div>

    <div class="main-chat">
      <div class="chat-title">Conversation avec Sonia</div>
